                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {imgPrincipales &&
                                                imgPrincipales[0] && (
                                                    // <img src={`http://localhost:8000/${imgPrincipales[0]}`} alt="" width={'97%'} className='img-fluid mx-auto' style={{ height:'250px',borderRadius:'15px', marginTop:'5px' }}/>
                                                    <img
                                                        src={`https://api.gampy.ch/${imgPrincipales[0]}`}
                                                        alt=""
                                                        width={"100%"}
