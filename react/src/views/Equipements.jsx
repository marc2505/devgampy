...
export default function Equipements(props) {
    ...
    const handleCheckboxChange = (i, e) => {
        // e.preventDefault()
        setEquipements((prev) =>
            prev.map((equip, index) =>
                index === i
                    ? { ...equip, showPhotos: !equip.showPhotos }
                    : equip
            )
        );
    ...
    const handleEquipementPhotos = (i, e) => {
        ...
        setEquipements((prev) =>
            prev.map((equip, index) =>
                index === i ? { ...equip, photos: filesArray } : equip
            )
        );
        if (e.target.files) {
            const filesArray = Array.from(e.target.files).map((file) => {
    ...
    return (
        <div>
            ...
            <div className="row text-center">
                {loading && <div>CHARGEMENT DES DONNEES ...</div>}
                {!loading &&
                                ...
                                <ul className="list-group mb-3">
                                    <li className="list-group-item">
                                        <input
                                            ...
                                            checked={newCheckboxChecked.includes(
                                                `equipement-${equip.id}`
                                            )}
                                        ...
                                        <label
                                            ...
                                            className="form-check-label stretched-link me-3"
                                        >
                                            {equip.nom}{" "}
                                        </label>
                                        {equip.nom === "Piscine" ? (
                                            ...
                                            <FaWifi />
                                        ) : equip.nom === "Eau potable" ? (
                                            <FaHandHoldingWater />
                                        ) : equip.nom === "Toilette sèche" ? (
                                            <FaToilet />
                                        ) : equip.nom ===
                                          "Douche extérieure" ? (
                                            <FaShower />
                                        ) : equip.nom === "Electricité" ? (
                                            <MdElectricBolt />
                                        ) : equip.nom === "Table" ? (
                                            <MdTableRestaurant />
                                        ) : equip.nom === "Barbecue" ? (
                                          ...
                                          "Cuisine extérieure" ? (
                                            <FaKitchenSet />
                                        ) : equip.nom === "Local vélo" ? (
                                            <GrBike />
                                        ) : equip.nom === "Machine à laver" ? (
                                            <GiWashingMachine />
                                        ) : equip.nom === "Étendoir" ? (
                                            <GiClothespin />
                                        ) : (
